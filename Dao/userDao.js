...
const saveOtp = async (req, res, otp, username) => {
  ...
  return await User.updateOne(
    ...
    {
      $set: { OTP: otp, OtpStatus: "Pending", Location: timezone, file: null },
    },
    { multi: true },
    function (err, user) {
...
const findEmail = async (req, res, username) => {
  return await User.findOne({ username: username });
};
const deleteOtp = async (req, res, EmailId) => {
  return await User.updateOne({ EmailId: EmailId }, { $unset: { OTP: "" } });
};
const deleteuser = async (req, res, EmailId) => {
  return await User.findOneAndDelete({ EmailId: EmailId });
};
...
const expiredOtpUser = async (req, res, username) => {
  return await User.updateOne(
    { username: username, OtpStatus: "Pending" },
    {
